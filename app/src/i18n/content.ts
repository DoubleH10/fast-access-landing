...
const ar = {
  ...
  pages: {
    ...
    whoTitle: 'من نحن',
    whoBody: 'Fast Access شركة تشغيلية لوجستية — التيار المحرّك لنمو أعمال المتاجر الإلكترونية. بدأنا بطموح تمكين العلامات التجارية من تأسيس نموها وتسهيل وصولها لعملاء أكبر، عبر توفير منظومة تحتية متكاملة لتنفيذ طلبات العملاء بدون تعقيدات، بدون تأخير، بدون مشكلات، وبأقل التكاليف.',
  },
  hero: {
    eyebrow: 'الشريك الأسرع لنموك التجاري',
    headlineA: 'التيار المحرّك لنمو أعمال',
    headlineHighlight: 'المتاجر الإلكترونية',
    headlineB: '.',
    sub: 'كل ما يحتاجه متجرك — تخزين، تجهيز، شحن، ومتابعة لحظية — تحت أمرك.',
  ...
  partner: {
    ...
    headlineA: 'Fast Access مو بس يعرض لك خدمات —',
  ...
  stats: {
    chip: 'الأرقام تتكلم',
    headlineA: 'من بعد الحين لا تشيل هم',
    headlineHighlight: 'كيف أشحن طلبات متجري',
    headlineB: '؟',
    body: 'لأن كل طلب يستلمه فريقنا يوصل للعميل — بأمان.',
    items: [
      { value: 500, suffix: '+', label: 'تاجر وسّعنا نموه' },
      { value: 25, suffix: 'K', label: 'منتج نستقبله يوميًا' },
      { value: 1.2, suffix: 'M', label: 'طلب وصّلناه بأمان' },
  ...
  sectors: {
    chip: 'القطاعات',
    headlineA: 'وش ما كان نوع تجارتك،',
    headlineHighlight: 'Fast Access موجود عشانك',
    headlineB: '.',
  ...
  results: {
    ...
    headlineB: '؟',
    items: [
      { name: 'علامة أزياء، الرياض', before: 'الطلبات تستغرق ٣ إلى ٥ أيام والتغليف يأكل كل مساء.', after: 'توصيل في نفس اليوم داخل المدينة، والمؤسّس ما لمس صندوقًا من يومها.' },
      { name: 'متجر تجميل، جدة', before: 'المرتجعات تتكدّس بسبب طرود تالفة وسيئة التغليف.', after: 'تغليف مُحكَم بهوية العلامة خفّض المرتجعات لأدنى حد.' },
      { name: 'علامة مكمّلات، الدمام', before: 'لا رؤية للطلبات — العملاء يسألون «وين طلبي؟» يوميًا.', after: 'لوحة تحكم لحظية تجاوب قبل لا يسألون.' },
    ],
  },
  footer: {
