...
const ar = {
  ...
  coverage: {
    ...
    body: 'من الرياض إلى كل مدينة رئيسية في المملكة — تخزين وتوصيل وتغطية شاملة، مع مراكز توصيل بنفس اليوم، وشحن سريع لدول الخليج، وشحنات دولية عبر أقوى شركاء الشحن.',
  },
  pricing: {
